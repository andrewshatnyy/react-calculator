...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculator = __webpack_require__(46);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  _app2.default,
	  { store: (0, _redux.createStore)(_reducer.reducer) },
...
/***/ function(module, exports) {
	...
	function compute(last, _ref) {
	  ...
	  return { display: computed, mem: original, last: last, reset: true };
	}

	function run(_ref2, op) {
	  var display = _ref2.display;
	  var mem = _ref2.mem;
	  var last = _ref2.last;
	  var reset = _ref2.reset;

	  var state = { display: display, mem: mem, last: last, reset: true };
	  switch (op) {
	    case 'plusminus':
	      return { display: '' + ops.negate(display), mem: mem, reset: false, last: last };
	    case 'plus':
	      return compute('add', { display: display, mem: mem, reset: reset });
	    case 'minus':
	      return compute('sub', { display: display, mem: mem, reset: reset });
	    case 'divide':
	      return compute('div', { display: display, mem: mem, reset: reset });
	    case 'times':
	      return compute('mul', { display: display, mem: mem, reset: reset });
	    case 'percent':
	      return { display: ops.per(display), mem: mem, last: '', reset: true };
	    case 'equal':
	...
	function digit(_ref3, number) {
	  ...
	  if (number === '.') {
	    if (dot) return {};
	    return { dot: true, display: concat(display, number), reset: reset };
	  }
	  return { display: concat(display, number), mem: mem, reset: reset };
	}

	function reducer(prevState, action) {
	  var state = prevState || cleanState();
	  Object.freeze(state);
	  switch (action.type) {
	    case 'operator':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDebugTool = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _head = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Head = function (_React$Component) {
	  ...
	  _createClass(Head, [{
	    ...
	    key: "genStyle",
	    value: function genStyle(display) {
	      var base = 48;
	      var limit = 8;
	      var digits = display.length;
	      if (digits < limit + 1) return {};
	      var koef = base / (limit / 2);
	      return {
	    ...
	    value: function render() {
	      ...
	      var display = _store$getState.display;

	      var result = "" + (display || 0);
	      var style = this.genStyle(result);
	      return _react2.default.createElement(
	        "div",
	        { className: "calculator-head" },
	        _react2.default.createElement(
	          "div",
	          { className: "calculator-result", style: style },
	          result
	        )
	      );
	    }
	...
	function Controls() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      Row,
	      null,
	      _react2.default.createElement(_button2.default, { types: ['gray', 'gray--dark', 'small-text'], value: 'AC' }),
	      _react2.default.createElement(_button2.default, { types: ['gray', 'gray--dark'], operator: 'plusminus' }),
	      _react2.default.createElement(_button2.default, { types: ['gray', 'gray--dark'], operator: 'percent' }),
	      _react2.default.createElement(_button2.default, { operator: 'divide' })
	    ),
	    _react2.default.createElement(
	      Row,
	      null,
	      [7, 8, 9].map(function (num) {
	        return _react2.default.createElement(_button2.default, { key: num, types: ['gray'], value: num });
	      }),
	      _react2.default.createElement(_button2.default, { operator: 'times' })
	    ),
	    _react2.default.createElement(
	      Row,
	      null,
	      ...
	      _react2.default.createElement(_button2.default, { operator: 'minus' })
	    ),
	    _react2.default.createElement(
	      Row,
	      null,
	      ...
	      _react2.default.createElement(_button2.default, { operator: 'plus' })
	    ),
	    _react2.default.createElement(
	      Row,
	      null,
	      _react2.default.createElement(_button2.default, { types: ['gray', 'gray--wide'], value: '0' }),
	      _react2.default.createElement(_button2.default, { types: ['gray'], value: '.' }),
	      _react2.default.createElement(_button2.default, { operator: 'equal' })
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _operator = __webpack_require__(50);
	...
	function Button(_ref, _ref2) {
	  ...
	  var classes = mapClasses(types);
	  var action = actionType(value, operator);
	  var operatorNode = operator ? _react2.default.createElement(_operator2.default, { type: operator }) : value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Operator(_ref) {
	  ...
	  var classes = 'operator operator-' + type;
	  return _react2.default.createElement(
	    'span',
	    { className: classes },
	    type === 'plusminus' ? _react2.default.createElement('span', null) : null
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(119);
